...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		header("Location: ".$cfg_baseurl."account/logout");
	} else if ($data_user['level'] == "Agen" OR $data_user['level'] == "Reseller" OR $data_user['level'] == "Member") {
...
<h6 class="card-header"><i class="mdi mdi-account-settings-variant"></i> Tambah Reseller</h6>
<div class="card-body">
                <div class="col-md-12">
