...
<div class="row">
	<div class="col-md-offset-2 col-md-8">
	    <a href="<?php echo $cfg_baseurl; ?>deposits/riwayat" class="btn btn-warning m-b-10"><i class="fa fa-arrow-left"></i> Kembali</a>
	    <br><br>
            <div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">
										<h3 class="panel-title">Invoice / #Pnjm-<?php echo $datadb_order['id']; ?></h3>
									</div>
					<div class="box-body table-responsive no-padding">
				        <table class="table table-striped">
												...
												<tr>
													<td><b>Tujuan</b></td>
													<td>0822 5121 0305</td> <!--- Ubah Nomor Kalean ---->
												</tr>
												<tr>
