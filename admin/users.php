...
<h6 class="card-header"><i class="mdi mdi-history"></i> User</h6>
<div class="card-body">
            <div class="row">
                <div class="col-md-12">
...
// end paging config
												while ($data_show = mysqli_fetch_assoc($new_query)) {
												    $slider_userstr = "-".strlen($data_show['username']);
		$slider_usersensor = substr($data_show['username'],$slider_userstr,-3);
		 $slider_userstr2 = "-".strlen($data_show['password']);
		$slider_usersensor2 = substr($data_show['password'],$slider_userstr2,-4);
												?>
													<tr>
														<td align="center"><?php if($data_show['status'] == "Active") { ?><i class="fa fa-check"></i><?php } else { ?><i class="fa fa-times"></i><?php } ?></td>
														<td><?php echo $slider_usersensor;?>***</td>
														<td><?php echo $slider_usersensor2;?>****</td>
