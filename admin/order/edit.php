...
<h6 class="card-header"><i class="mdi mdi-history"></i> Ubah Data Pembelian</h6>
<div class="card-body">
										<?php 
										if ($msg_type == "success") {
										?>
										...
										<form class="form-horizontal" role="form" method="POST">
											...
											<a href="<?php echo $cfg_baseurl; ?>admin/orders" class="btn btn-warning"><i class="fa fa-refresh"></i> Kembali </a>												
											    </div>
											</div>
										</form>
									</div>
