...
<h6 class="card-header"><i class="mdi mdi-history"></i> Detail Informasi</h6>
<div class="card-body">
										<?php 
										if ($msg_type == "success") {
										?>
										...
										?>
								<a href="<?php echo $cfg_baseurl; ?>admin/information/add" class="btn btn-info btn-bordred m-b-20"><i class="fa fa-plus"></i> Tambah Berita </a>
...
// end paging config
												...
												?>
													<tr>
														...
														<td align="center">
														<a href="<?php echo $cfg_baseurl; ?>admin/information/edit?id=<?php echo $data_show['id']; ?>" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i></a>
