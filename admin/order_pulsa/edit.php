                ...
                <div class="col-lg-12">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-shopping-cart"></i> Ubah Data Pembelian</h3>
                                </div>
                		<div class="panel-body">
										...
										<form class="form-horizontal" role="form" method="POST">
											...
											<a href="<?php echo $cfg_baseurl; ?>admin/orders_pulsa.php" class="btn btn-info btn-bordered waves-effect w-md waves-light"><i class="fa fa-arrow-left"></i> Kembali ke daftar</a>
											<div class="pull-right">
												<button type="submit" class="btn btn-success btn-bordered waves-effect w-md waves-light" name="edit"><i class="fa fa-edit"></i> Ubah</button>
											</div>
										</form>
									</div>
								</div>
