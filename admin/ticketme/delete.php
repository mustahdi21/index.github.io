	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_GET['id'])) {
			...
			if (mysqli_num_rows($check_ticket) == 0) {
				header("Location: ".$cfg_baseurl."admin/ticketsku.php");
			} else {
     ...
     <!-- Breadcrumb -->
            <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
                <li class="breadcrumb-item ">
                    <a href="">Hapus Tiket</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="#"><?php echo $logo_white; ?></a>
                </li>
                <li class="breadcrumb-item">
                    <a href="#">Fiture Developer</a>
                </li>
                <li class="breadcrumb-item active">Hapus Tiket</li>
                            ...
                            <div class="col-md-2"></div><div class="col-md-8">
                                <div class="panel panel-color panel-info">
                                    ...
                                    <div class="panel-body">
										<form class="form-horizontal" role="form" method="POST" action="<?php echo $cfg_baseurl; ?>admin/ticketsku.php">
											...
											<a href="<?php echo $cfg_baseurl; ?>admin/ticketsku" class="btn btn-default waves-effect w-md waves-light">Kembali</a>
											    </div>
										    </div>
										</form>
									</div>
