     ...
     <!-- Breadcrumb -->
            <ol class="breadcrumb bc-colored bg-theme" id="breadcrumb">
                <li class="breadcrumb-item ">
                    <a href="">History Aktifitas</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="#"><?php echo $logo_white; ?></a>
                </li>
                <li class="breadcrumb-item active">History Aktifitas</li>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-color panel-info">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-trophy"></i> 50 LAST HISTORY AKTIFITAS</h3>
                                    </div>
...
<table id="datatable-responsive" class="table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
												...
												<tbody>
												<?php
													$check_user = mysqli_query($db, "SELECT * FROM ripalloglogin WHERE username = '$sess_username' ORDER BY id DESC LIMIT 50");
													$no = 1;
